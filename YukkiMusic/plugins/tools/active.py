...
async def activevc(_, message: Message):
    mystic = await message.reply_text("ɢᴇᴛᴛɪɴɢ ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇᴄʜᴀᴛꜱ....\nᴘʟᴇᴀꜱᴇ ʜᴏʟᴅ ᴏɴ")
    ...
    for x in served_chats:
        try:
            ...
            continue
    if not text:
        await mystic.edit_text("ɴᴏ ᴀᴄᴛɪᴠᴇ ᴄʜᴀᴛꜱ ꜰᴏᴜɴᴅ")
    else:
        await mystic.edit_text(
            f"**ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ'ꜱ:-**\n\n{text}",
...
async def vc(client, message: Message):
    ...
    await message.reply_text(f"ᴀᴄᴛɪᴠᴇ ᴄʜᴀᴛꜱ ɪɴꜰᴏ: {ac_audio}")
