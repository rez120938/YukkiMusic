    ...
    if url:
        ...
        try:
            ...
            await mystic.edit_text(
                "ᴛʜᴇʀᴇ'ꜱ ᴀɴ ɪꜱꜱᴜᴇ ᴡɪᴛʜ ᴛʜᴇ ʙᴏᴛ. ᴘʟᴇᴀꜱᴇ ʀᴇᴘᴏʀᴛ ɪᴛ ᴛᴏ ᴍʏ ᴏᴡɴᴇʀ ᴀɴᴅ ᴀꜱᴋ ᴛʜᴇᴍ ᴛᴏ ᴄʜᴇᴄᴋ ʟᴏɢɢᴇʀ ɢʀᴏᴜᴘ"
            )
            text = "ᴘʟᴇᴀꜱᴇ ᴛᴜʀɴ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.. ʙᴏᴛ ɪꜱ ᴜɴᴀʙʟᴇ ᴛᴏ ꜱᴛʀᴇᴀᴍ ᴜʀʟꜱ.."
